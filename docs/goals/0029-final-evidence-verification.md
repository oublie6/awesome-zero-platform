...
- Goal 0029 read/verification boundary is explicit.

### In progress

- Implementing immutable MySQL final-record retrieval and exact record reconstruction.

### Remaining

- Doudizhu completed/aborted verification, participant-authorized application query, documentation, and final verification.
